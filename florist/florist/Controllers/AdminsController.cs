...
namespace florist.Controllers
{
    public class AdminsController : ApiController
    {
        ...
        {
           Admin ad = db.Admins.Where(adm => adm.adminEmail.Equals(adminEmail) &&
        ...
        public IHttpActionResult PostAdmin(Admin admin)
        {
            ...
            return CreatedAtRoute("DefaultApi", new { id = admin.adId }, admin);
        }
        ...
        {
            return db.Admins.Count(e => e.adId == id) > 0;
        }
    }
}